...
Abrir el archivo TFG_Lucas_Paleo.ipynb en Google Colab.
Ejecutar todas las celdas en orden (Ctrl + F9 o “Runtime → Run all”).
El script:
...
En “Obtener datos → Archivo → CSV”, seleccionar uber_dataset_final.csv.
Verificar que las columnas se carguen correctamente.
Abrir o importar el archivo Dashboard_Uber.pbix (opcional, si querés ver el tablero ya diseñado).
